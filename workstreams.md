...
> * **Data quality**: There are known and unknown data quality problems including out-of-date TC sponsorship, inactive workstreams still represented, inaccurate use of SIG vs. working group distinction, missing parent child relationships, and more.
...
graph LR
  ...
  go_auto_instr["Go: Automatic Instrumentation<br/>GC: Juraci Paixão Kröhling<br/>TC: David Ashpole (E)<br/>TC Coverage: E:3%"]
  go_compile_instr["Go: Compile-Time Instrumentation<br/>GC: Juraci Paixão Kröhling<br/>TC: David Ashpole (E)<br/>TC Coverage: E:3%"]
  go["Go: SDK<br/>GC: Marylia Gutierrez<br/>TC: David Ashpole (L)<br/>TC Coverage: L:7%"]
