...
Once at least one SIG provides this application, the documentation can be updated to include the new learning experience, utilizing this application. We will leverage existing tools to [extract code excerpts](https://opentelemetry.io/docs/compatibility/) from external repositories and import the code directly into the website.
