...
| [process. - Process metrics](https://opentelemetry.io/docs/specs/otel/metrics/semantic_conventions/process-metrics/)                                                              | Similar to z/OS address space but different <br /> Support of Controll Block metrics  | z/OS and z/OS USS |
