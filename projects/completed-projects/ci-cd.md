...
| Ansible        | [Ansible OpenTelemetry Callback Plugin](https://docs.ansible.com/projects/ansible/latest/collections/community/general/opentelemetry_callback.html)                  |                                                                                                      | * Tracing and Logs in Ansible playbooks                                                                                   |
...
| TeamCity       | [TeamCity Build OpenTelemetry Exporter Plugin](https://github.com/OctopusDeploy/opentelemetry-teamcity-plugin)                                              |                                                                                                      | * Tracing of TeamCity builds                                                                                     |
| TeamCity       | [TeamCity Lens Plugin](https://plugins.jetbrains.com/plugin/20796-lens)                                                                                     | [Documentation](https://plugins.jetbrains.com/plugin/20796-lens/documentation)                       | * A TeamCity plugin that collects build events and metrics. OTel support is in progress                          |  
| Datadog        | [CI Pipeline Visibility in Datadog](https://docs.datadoghq.com/continuous_integration/pipelines/)                                                           |                                                                                                      | * Pipeline tracing for various platforms (e.g., GitHub, GitLab, CircleCI, Jenkins, TeamCity) offered by Datadog  |
