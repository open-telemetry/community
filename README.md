...
| Name | Meeting Time | Meeting Notes | Slack Channel | Meeting Invites | [Sponsors](./project-management.md#project-proposal)| [Governance Committee](./community-members.md#governance-committee) Liaison |
|------|--------------|---------------|---------------|-----------------|--------------------------------|--------------------------------|
