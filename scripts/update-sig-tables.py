...
for group in data:
    ...
    if group_name == "Specification SIGs":
        markdown_content += "| Name | Meeting Time | Meeting Notes | Slack Channel | Meeting Invites Group | [Technical Committee](./community-members.md#technical-committee) Sponsors| [Governance Committee](./community-members.md#governance-committee) Liaison |\n"
        markdown_content += "|------|--------------|---------------|---------------|-----------------|--------------------------------|--------------------------------|\n"
    else:
